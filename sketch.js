...
function setup() {
	...
	constraint2 = new String(bob2.body, roof.body, -105, 0);
	constraint3 = new String(bob3.body, roof.body, -70, 0);
	constraint4 = new String(bob4.body, roof.body, -35, 0);
	constraint5 = new String(bob5.body, roof.body, -0, 0);
